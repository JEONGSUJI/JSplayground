...
var removeTodo = function removeTodo(_ref2) {
  var target, res;
  return regeneratorRuntime.async(function removeTodo$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          _context2.next = 5;
          return regeneratorRuntime.awrap(axios["delete"]("/todos/".concat(target.parentNode.id)));
...
var toggleCheckBox = function toggleCheckBox(_ref3) {
  var target, id, completed, res;
...
var addTodo = function addTodo(_ref4) {
  var target, keyCode, content, res;
  return regeneratorRuntime.async(function addTodo$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          target = _ref4.target, keyCode = _ref4.keyCode;
        ...
        case 4:
          target.value = '';
          _context4.next = 7;
          return regeneratorRuntime.awrap(axios.post('/todos', {
            id: maxId(),
            content: content,
            completed: false
          }));
